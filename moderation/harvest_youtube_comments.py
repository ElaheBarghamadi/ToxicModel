...
OUT = Path(__file__).resolve().parent.parent / 'data-website' / 'collected_youtube_round3.csv'
QUERIES = [
    'واکنش هواداران پرسپولیس به باخت', 'کنفرانس خبری جنجالی عالی شاه',
    'سوتی زنده تلویزیون ایرانی', 'جواب دوربین مردم گرانی',
    'فحاشی هواداران به داور ورزشگاه', 'عصبانیت مجری زنده برنامه',
    'نقد سریال زخم کاری قسمت جدید', 'مصاحبه زنده عجیب فوتبالیست',
    'حواشی برنامه زنده فوتبالی', 'واکنش مردم به قیمت گوشی جدید',
]
