...
OUT = Path(__file__).resolve().parent.parent / 'tamrin2' / 'data' / 'raw_comments.csv'
QUERIES = [
    'آموزش پایتون فارسی مبتدی', 'دوره آموزش پایتون کامل', 'آموزش جنگو فارسی',
    'آموزش برنامه نویسی برای مبتدیان', 'چطور برنامه نویس شویم', 'آموزش react فارسی',
    'آموزش html و css فارسی', 'یادگیری ماشین آموزش فارسی', 'اشتباهات برنامه نویسان مبتدی', 'آموزش سی شارپ فارسی',
]
